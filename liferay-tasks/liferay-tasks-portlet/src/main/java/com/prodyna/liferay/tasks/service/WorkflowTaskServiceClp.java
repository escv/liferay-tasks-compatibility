...
public class WorkflowTaskServiceClp implements WorkflowTaskService {
    ...
    public WorkflowTaskServiceClp(InvokableService invokableService) {
        ...
        _methodName3 = "myWorkflowTasks";

        _methodParameterTypes3 = new String[] { "long" };

        _methodName4 = "groupWorkflowTasks";

        _methodParameterTypes4 = new String[] { "long" };

        _methodName5 = "assignMeWorkflowTask";

        _methodParameterTypes5 = new String[] { "long", "long" };

        _methodName6 = "completeWorkflowTask";
    ...
    public java.util.List<com.prodyna.liferay.tasks.service.model.PDWorkflowTask> myWorkflowTasks(
        ...
        return (java.util.List<com.prodyna.liferay.tasks.service.model.PDWorkflowTask>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.prodyna.liferay.tasks.service.model.PDWorkflowTask assignMeWorkflowTask(
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName5,
                    ...
                    new Object[] { companyId, workflowTaskId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
        ...
        return (com.prodyna.liferay.tasks.service.model.PDWorkflowTask) ClpSerializer.translateOutput(returnObj);
    }
